                ...
                <div className="mx-auto mt-11 w-80 transform overflow-hidden rounded-lg bg-white dark:bg-slate-800 shadow-md duration-300 hover:scale-105 hover:shadow-lg">
                    ...
                    <div className="p-4">
                        ...
                        <div className="rating">
                            <input type="radio" readOnly name="rating-2" className="mask mask-star-2 bg-orange-400" />
                            <input type="radio" readOnly name="rating-2" className="mask mask-star-2 bg-orange-400" checked />
                            <input type="radio" readOnly name="rating-2" className="mask mask-star-2 bg-orange-400" />
                            <input type="radio" readOnly name="rating-2" className="mask mask-star-2 bg-orange-400" />
                            <input type="radio" readOnly name="rating-2" className="mask mask-star-2 bg-orange-400" />
                        </div>
